          ...
          <div>
            ...
            <section id="privacy" className="mb-20">
              ...
              <div className="space-y-6 text-gray-700 leading-relaxed">
                <p>
                  FindGo is built with a <strong>privacy-first</strong> approach. This policy explains how we handle information within the FindGo mobile application.
                </p>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-3">
                    <li>
                      <strong>Location Data:</strong> FindGo requires access to your device’s <strong>Precise Location</strong> to pin your car’s position and show your current location relative to your vehicle.
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>No Accounts:</strong> You are not required to create an account or provide any personal information (name, email, or phone number) to use FindGo.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p>
                    <strong>Navigation:</strong> When you request directions, FindGo passes your saved coordinates to your choice of third-party maps (e.g., Google Maps or Apple Maps). These services operate under their own independent privacy policies.
                  </p>
                </div>
            ...
            <section id="terms">
              ...
              <div className="space-y-6 text-gray-700 leading-relaxed">
                <div>
                  ...
                  <p>By downloading or using FindGo, you agree to these terms. If you do not agree, please do not use the application.</p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-3 font-medium text-gray-800">
                    <li><strong>Parking Fines:</strong> FindGo is a reminder tool only. We are NOT responsible for parking tickets, fines, towing fees, or legal penalties.</li>
                ...
                <div>
                  ...
                  <p>
                    To the maximum extent permitted by law, FindGo and its developers shall not be liable for any loss of property, vehicle damage, or incidental damages resulting from the use of this application.
                  </p>
                </div>
              </div>
            </section>
            ...
            <footer className="mt-20 pt-8 border-t border-gray-100 text-center text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} FindGo App. All rights reserved.
            </footer>
          </div>
        </div>
      </main>
